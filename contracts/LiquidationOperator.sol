...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    receive() external payable {
        require(msg.sender == address(weth_pool), "Only WETH pool can send ETH");
    }
    // END TODO
    ...
    function operate() external {
        ...
        // 0. secuity checks and initializing variables
